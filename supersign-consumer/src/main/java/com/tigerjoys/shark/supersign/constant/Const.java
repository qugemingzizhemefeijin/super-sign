...
public final class Const {
	 ...
	 * 文件存储根路径
	 */
	public static final String STORAGE_PATH = properties.getProperty("storage_path");
	 ...
	 * RUBY脚本的根地址
	 */
	public static final String SCRIPT_RUBY_PATH = properties.getProperty("script_path");
