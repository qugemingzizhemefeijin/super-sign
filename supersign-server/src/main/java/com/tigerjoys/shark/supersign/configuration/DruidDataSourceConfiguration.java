...
//@MapperScan(basePackages = {"com.tigerjoys.shark.miai.inter.mapper"},sqlSessionFactoryRef = "sqlSessionFactory")
public class DruidDataSourceConfiguration {
	...
	public ServletRegistrationBean<Servlet> druidStatViewServle() {
		ServletRegistrationBean<Servlet> servletRegistrationBean = new ServletRegistrationBean<>(new StatViewServlet(),"/tiger/druid_stat/*");
		...
		// 登录查看信息的账号密码.
		servletRegistrationBean.addInitParameter("loginUsername", "ooo");
		servletRegistrationBean.addInitParameter("loginPassword", "ooo");
		// 是否能够重置数据.
